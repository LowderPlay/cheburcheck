...
<KbArticle>
	...
	<KbHeading id="как-это-работает">Как это работает</KbHeading>
	<p>
	...
	<KbHeading id="что-показывает-результат">Что показывает результат</KbHeading>
	<p>
	...
	<ul class="list-disc">
		...
		<li>
			...
			>
				Белый список
			</a> – похоже на блокировку по домену сайта в начале HTTPS-соединения.
			Вероятнее всего, указывает на блокировку сайта на ТСПУ.
		</li>
		<li>
	...
	<KbHeading id="подробности-по-хостам">Подробности по хостам</KbHeading>
	<p>
	...
	<KbHeading id="почему-результаты-могут-отличаться">
